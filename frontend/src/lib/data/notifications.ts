...
export const ownerNotifications: NotificationItem[] = [
  ...
  { id: "on-1d", type: "expense", title: "Payroll due in 7 days", description: "September payroll of £14,700 is due on the 28th — 9 staff.", timestamp: "This morning", read: false, priority: "high", href: "/owner/finances?tab=expenses&status=pending" },
  { id: "on-1e", type: "expense", title: "Software spend is up 52% this month", description: "Two new subscriptions (BookFlow, GymFlow CRM add-on) pushed September software costs higher than usual.", timestamp: "2 days ago", read: true, priority: "low", href: "/owner/finances?tab=overview" },
